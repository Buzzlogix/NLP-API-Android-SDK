...
public class SentimentController extends BaseController {
    ...
    public void createReturnEnglishGeneralSentimentAsync(
            final String body,
        ...
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5605928145712896865L;
            {
     ...
     * @param    body    Required parameter: Supply text to be classified.
	 * @return	Returns the LinkedHashMap<String, Object> response from the API call*/
    public void createReturnEnglishGeneralSentimentFormAsync(
            final String body,
            final APICallBack<LinkedHashMap<String, Object>> callBack
    ) {
        //the base uri for api requests
        ...
        //prepare query string for API call
        StringBuilder queryBuilder = new StringBuilder(baseUri);
        queryBuilder.append("/sentiment/form");
        //validate and preprocess url
        String queryUrl = APIHelper.cleanUrl(queryBuilder);

        //load all headers for the outgoing API request
        Map<String, String> headers = new HashMap<String, String>() {
            private static final long serialVersionUID = 5678027859177292874L;
            {
                    put( "user-agent", "APIMATIC 2.0" );
                    put( "accept", "application/json" );
                    put( "apikey", Configuration.getApikey() );
